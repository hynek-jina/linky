...
- Rotations prune stale lanes locally (`n-2`) for cashu/messages/transactions, keeping one previous lane for short rollback/history; contacts keep historical lanes visible instead of pruning/copying forward rows
