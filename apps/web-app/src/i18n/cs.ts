export const cs = {
  ...
  spdPaymentRequestReimbursementFor: "Poptat proplacení u {name}",
  ...
  spdPaymentOfferSent: "Nabídka odeslána: {name}",
  ...
  bankPaymentOfferIncomingDescription:
    "Přijmi nabídku, pokud chceš za tento kontakt provést bankovní platbu ve výši {amount}.",
  ...
  bankPaymentOfferBannerIncoming: "{name} poptává proxy platbu {amount}",
  bankPaymentOfferBannerOutgoing: "Poptáváte proxy platbu {amount}",
  bankPaymentOfferBannerAcceptedBy: "{name} má zájem o platbu {amount}",
  ...
  bankPaymentOfferProgressAccept: "Přijetí nabídky",
  bankPaymentOfferProgressBankDetails: "Údaje",
  bankPaymentOfferProgressBankPayment: "Fiat platba",
  bankPaymentOfferProgressSats: "Bitcoin vyrovnání",
  bankPaymentOfferSendFunds: "Odeslat prostředky",
  ...
  bankPaymentOfferTimeRemainingHours: "Zbývá {hours} h",
  bankPaymentOfferTimeRemainingMinutes: "Zbývá {minutes} min",
